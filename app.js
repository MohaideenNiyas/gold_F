...
async function fetchGoldPrice() {
    try {
        ...
        const response = await fetch('https://www.goldapi.io/api/XAU/INR', {
            headers: {
                'x-access-token': 'goldapi-vdy7rsm1x554j0-io',
        ...
        const goldPriceINRPerOunce = data.price;
        goldPricePerGramINR = goldPriceINRPerOunce / 31.1035;
        goldPriceElement.innerHTML = `₹${goldPricePerGramINR.toFixed(2)} INR / gram`;
    } catch (error) {
